...
begin
  ...
  begin
    ...
    begin
      if acao = 'B' then
      begin
        Venda.Form6.EditClienteID.Text := qryCarregar.FieldByName('CodClient').AsString;
        Close;
      end;
      end
      else
...
begin
  try
    ...
    qryDelete.SQL.Clear;
    qryDelete.SQL.Add('DELETE FROM Cliente WHERE CodClient = :codClient');
    qryDelete.ParamByName('codClient').AsInteger := id;
    qryDelete.ExecSQL;
