...
begin
  try
    ...
    if acao = 'I' then
    begin
      qrySalvar.SQL.Add('INSERT INTO Venda (data, produto, subtotal,cliente, quantidade) VALUES (:data, :produto, :subtotal, :cliente, :quantidade)');
    ...
    begin
      qrySalvar.SQL.Add('UPDATE Venda SET data = :data, produto = :produto, subtotal = :subtotal, quantidade = :quantidade, cliente = :cliente WHERE id = :id');
